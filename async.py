...
file_paths = ["failed_at_1.txt", "success.txt", "failed_at_2.txt","302.txt"]
...
async def get_movie_info(movie_id, session):  # function to get the movie info
    ...
    await asyncio.sleep(random.uniform(20, 40))  # sleep for a random time
